...
static bind_t g_bindings[] = 
{
	...
	{"automap", 		"automap",			ID_AUTOMAP,		ANIM_IDLE,		-1,				-1,		-1, -1},
...
static menucommon_s *g_misc_controls[] = {
	...
	(menucommon_s *)&s_controls.automap,
...
static void Controls_MenuInit( void )
{
	...
	s_controls.automap.generic.type		 = MTYPE_ACTION;
	s_controls.automap.generic.flags	 = QMF_LEFT_JUSTIFY|QMF_PULSEIFFOCUS|QMF_GRAYED|QMF_HIDDEN;
	s_controls.automap.generic.callback	 = Controls_ActionEvent;
	s_controls.automap.generic.ownerdraw = Controls_DrawKeyBinding;
	s_controls.automap.generic.id		 = ID_AUTOMAP;
	...
	Menu_AddItem( &s_controls.menu, &s_controls.automap );
