...
void UI_Init( void ) {
	...
	ui_cursorOffset = Q_stricmp( fsGame, "cpma-ap" ) ? 16 : 0;
...
void UI_Refresh( int realtime )
{
	...
	// draw cursor
	UI_SetColor( NULL );
	UI_DrawHandlePic( uis.cursorx-ui_cursorOffset, uis.cursory-ui_cursorOffset, 32, 32, uis.cursor);
