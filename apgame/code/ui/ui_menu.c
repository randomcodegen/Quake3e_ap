...
void UI_MainMenu( void ) {
	...
	y += MAIN_MENU_VERTICAL_SPACING;
	s_main.archipelago.generic.type		= MTYPE_PTEXT;
	s_main.archipelago.generic.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_main.archipelago.generic.x			= 320;
	s_main.archipelago.generic.y			= y;
	s_main.archipelago.generic.id			= ID_ARCHIPELAGO;
	s_main.archipelago.generic.callback	= Main_MenuEvent;
	s_main.archipelago.string				= "SINGLE PLAYER";
	s_main.archipelago.color				= color_red;
	s_main.archipelago.style				= style;
	...
	Menu_AddItem( &s_main.menu,	&s_main.archipelago );
